...
app.get('/', (req, res) => {
    if (req.query.alcohol) {
        let filteredcocktails = cocktails.filter(element => element.contains.indexOf(req.query.alcohol) >= 0);
        res.render('home', { cocktails: filteredcocktails, alcoholList: alcoholList })
    } else {
