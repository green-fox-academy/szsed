...
class BlogPost {
    ...
    constructor(an: string, title: string, text: string, pd: string){
...
let postTwo = new BlogPost('Tim Urban', 'Wait but why', 'A popular long-form, stick-figure-illustrated blog about almost everything.', '2010.10.10.');
